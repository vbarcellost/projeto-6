...
export const theme = { pink: '#F87DA8', brown: '#9A6A4F', cream: '#F7EDE3', tan: '#CEA889', terracotta: '#D37B55', white: '#FFF', text: '#9A6A4F' }
...
export const Header = styled.header`
  height: ${({ $home }) => $home ? '384px' : '186px'}; color: ${({ theme }) => theme.brown}; background-color: ${({ theme }) => theme.cream};
...
export const Card = styled.article`position: relative; border: 1px solid ${({ theme }) => theme.brown}; background: white; display: flex; flex-direction: column;`
...
export const Tag = styled.span`background: ${({ theme }) => theme.pink}; color: ${({ theme }) => theme.brown}; padding: 6px 8px; font-size: 12px; font-weight: 700;`
...
export const MenuCard = styled.article`
  background: ${({ theme }) => theme.brown}; color: white; padding: 8px; display: flex; flex-direction: column; min-width: 0;
...
export const Footer = styled.footer`
  min-height: 298px; padding: 40px 16px; display: flex; flex-direction: column; align-items: center; background: ${({ theme }) => theme.pink}; color: ${({ theme }) => theme.brown}; text-align: center;
...
export const Modal = styled.div`
  position: relative; width: min(1024px, 100%); padding: 32px; display: grid; grid-template-columns: 280px 1fr; gap: 24px; background: ${({ theme }) => theme.brown}; color: white;
...
export const CartDrawer = styled.aside`
  position: absolute; top: 0; right: 0; width: min(360px, 100%); height: 100%; overflow-y: auto; padding: 32px 8px; background: ${({ theme }) => theme.brown}; color: ${({ theme }) => theme.cream};
